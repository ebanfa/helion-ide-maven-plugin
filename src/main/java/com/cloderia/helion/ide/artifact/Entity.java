...
public class Entity implements ArtifactData {
	...
	private String entityServiceTemplate;
...
/**
	...
	/**
	 * @return the entityServiceTemplate
	 */
	public String getEntityServiceTemplate() {
		return entityServiceTemplate;
	}

	/**
	 * @param entityServiceTemplate the entityServiceTemplate to set
	 */
	@XmlElement
	public void setEntityServiceTemplate(String entityServiceTemplate) {
		this.entityServiceTemplate = entityServiceTemplate;
	}
