 ...
 * @author Edward Banfa
 */
public abstract class AbstractServiceModuleProcessor<T extends ServiceModule> extends AbstractModuleProcessor<T> {

	public AbstractServiceModuleProcessor(Class<T> moduleImplClass) {
	...
	protected List<T> getModules(Application application, PipelineContext context) {
		return application.getServiceModules();
	}
